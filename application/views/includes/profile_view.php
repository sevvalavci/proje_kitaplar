...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="text-center mt-4 name"> <?php echo $this->session->userdata('kadi'); ?>Profilim </div>
        <form action="<?php echo base_url("profile/profiledata"); ?>" method="POST" class="p-3 mt-3">
            ...
            <button class="btn mt-3">Profili Düzenle</button>
        </form>
        <div class="row">
            <div class="text fs-6"> <a href="<?php echo base_url('logout'); ?>">Çıkış Yap</a> </div>
            <div class="text fs-6">
